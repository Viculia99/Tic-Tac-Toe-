...
/* Функція, що перевіряє, чи виграє певний гравець */
...
/* Функція для перевірки того, виграє людина,чи комп'ютер */
...
/* Переміщення можливе якщо вибрана клітинка порожня */
...
/* Встановлення можливості руху, якщо координати дійсні*/
...
/* *** Функція AI, яка вибирає найкращий хід *** */
...
/* Функція, яка викликає функцію мінімакс */
function aiTurn() {
	var x, y;
	var move;
	var cell;
